...
// Tableau des images
let images = ["img/home-bg.jpg", "img/nature-bg.jpg", "img/about-bg.jpg", "img/contact-bg.jpg", "img/post-bg.jpg"];
...
function createArrow() {
    ...
    $(".masthead").prepend(
        `<div style="position: absolute;z-index: 1;top: 50%;cursor: pointer">`
    ...
    $(".masthead").append(
        `<div style="position: absolute;z-index: 1;right: 0;top: 50%;cursor: pointer">`
